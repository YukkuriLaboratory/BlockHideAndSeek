...
public class PreparationTime {
    ...
    public static void teamMessage() {
        ...
        Team seekers = TeamCreateandDelete.getSeekersTeam();
        ...
        Team hiders = TeamCreateandDelete.getHidersTeam();
    ...
    public static void update() {
        ...
        var isAllPlayerMimicked = TeamCreateandDelete.getHidersTeam().getPlayerList().size() == hideMimicList.size();
