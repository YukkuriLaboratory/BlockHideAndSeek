...
API](https://www.curseforge.com/minecraft/mc-mods/fabric-api)、[CompleteConfig(
Fabric)](https://www.curseforge.com/minecraft/mc-mods/completeconfig)、[Fabric Language
